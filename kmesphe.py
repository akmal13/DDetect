...
pf = DataFrame(Data,columns=['a','b'])

print('Panjang DF : ' + str(len(pf)))
...
root= tk.Tk()
print('SKM')
print(skm.labels_.astype(int))
sphekm = skm.labels_.astype(int)
...
#print('KM pada 117 : '+str(kmscer[117]))
for x in range (len(kmscer)):
    if sphekm[x] != kmscer[x]:
        print('Pada index : '+str(x)+' Dengan sphere : '+str(sphekm[x])+' dan KM : '+str(kmscer[x]))
        print(print(len(dataperip[x][3])))
...
# print(dataperip[117][0]) # Hack 1 Right
# print(kmscer[117])
# print(len(dataperip[117][3]))
# print(dataperip[118][0]) # Hack 2 Right
# print(kmscer[118])
# print(len(dataperip[118][3]))
# print(dataperip[119][0]) # Hack 3 Right
# print(kmscer[119])
# print(len(dataperip[119][3]))
# print(dataperip[120][0]) # Normal 1 Wrong
# print(kmscer[120])
# print(len(dataperip[120][3]))
# print(dataperip[121][0]) # Normal 2 
# print(kmscer[121])
# print(len(dataperip[121][3]))
# print(dataperip[122][0]) # Normal 3
# print(kmscer[122])
# print(len(dataperip[122][3]))

#tp = len(dataperip[117][3]) + len(dataperip[118][3]) + len(dataperip[119][3])
